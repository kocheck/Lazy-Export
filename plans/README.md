...
|------|-------|----------|--------|------------|--------|
| [001](001-verification-baseline.md) | Verification baseline (typecheck + tests green + CI) | F1, F3-typings | L | — | PLANNED |
...
| [006](006-dependency-security.md) | Dependency security bumps | F6 | M | 001 | PLANNED |
